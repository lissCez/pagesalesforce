 ...
 const Home = () => {
    return(
        <>
            ...
            <section className="fundoBorrado letrabranca">
                <Menu/>
                ...
                <button id='butao1'><a href=''>COMEÇAR QUIZ</a></button>
            </section>
            <section className="fundoBorrado">
                ...
                <button id='butao2'><a href=''>Próximo</a></button>
                <div id="imgCoelho">
            ...
            <section className="fundoBorrado">
                ...
                <button id='butao3'><Link to='/Teste10Minutos'>Teste Grátis</Link></button>
